<x-store-layout>
    ...
    @if(session('success'))
            <div class="flex justify-end mt-2">
                <div class="flex flex-col justify-between w-1/4 px-4 py-2 my-4 text-green-700 bg-green-100 border-t-4 border-green-700 rounded">
    ...
    @if(session('error'))
            <div class="flex justify-end mt-2">
                <div class="flex flex-col justify-between w-1/4 px-4 py-2 my-4 text-red-700 bg-red-100 border-t-4 border-red-700 rounded">
        ...
        <div class="md:flex md:items-center">
            ...
            <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                ...
                <div class="flex items-center mt-6">
                    <button
                        class="px-8 py-2 text-sm font-medium text-white bg-indigo-600 rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500"><a  href="{{ route('cart.add', ['product' => $product->id]) }}">Order
                        Now</a></button>
